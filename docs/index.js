...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {library: a, playlist: b, libraryFilter: c, selected: d};
	});
var _user$project$Main$Track = F8(
...
var _user$project$Main$keyTypeDecoder = function (value) {
	return _elm_lang$core$Json_Decode$succeed(
		_user$project$Main$keyType(value));
};
var _user$project$Main$trackDecoder = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$Main$Track,
	A2(_elm_lang$core$Json_Decode$field, 'cd', _elm_lang$core$Json_Decode$int),
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'keyType',
		A2(_elm_lang$core$Json_Decode$andThen, _user$project$Main$keyTypeDecoder, _elm_lang$core$Json_Decode$string)));
var _user$project$Main$tracksDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'tracks',
	...
	_elm_lang$core$Json_Decode$list(_user$project$Main$trackDecoder));
var _user$project$Main$LoadedTracks = function (a) {
	return {ctor: 'LoadedTracks', _0: a};
};
...
var _user$project$Main$init = {
	...
	_1: _user$project$Main$loadTracks
};
...
var _user$project$Main$LoadTracks = {ctor: 'LoadTracks'};
var _user$project$Main$LibraryFilter = function (a) {
	return {ctor: 'LibraryFilter', _0: a};
};
var _user$project$Main$libraryFilter = function (query) {
	return A2(
		_elm_lang$html$Html$input,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$LibraryFilter),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
};
var _user$project$Main$ToggleSelection = function (a) {
	return {ctor: 'ToggleSelection', _0: a};
};
var _user$project$Main$RemoveTrack = function (a) {
		...
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'list-style-type', _1: 'decimal'},
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$selectedStyle, track, maybeSelected),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$ToggleSelection(track)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$span,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$RemoveTrack(index)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$AddTrack = F2(
	function (a, b) {
		return {ctor: 'AddTrack', _0: a, _1: b};
	});
var _user$project$Main$libraryLi = F2(
	function (maybeSelected, track) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$span,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								A2(_user$project$Main$AddTrack, track.cd, track.number)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$matchLi = F2(
	function (maybeSelected, track) {
		return A2(
			_elm_lang$html$Html$li,
			{
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Library'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$libraryFilter(state.libraryFilter),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$libraryLi(state.selected),
							A2(_user$project$Main$filter, state.libraryFilter, state.library))),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$h2,
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										A2(
											_elm_lang$core$List$map,
											_user$project$Main$matchLi(state.selected),
											A3(_user$project$Main$matches, state.library, state.playlist, state.selected))),
									_1: {ctor: '[]'}
								}
							}
						}
